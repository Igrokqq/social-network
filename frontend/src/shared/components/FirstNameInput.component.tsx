...
export default function FirstNameInput({ form, isReadonly, value }: any): JSX.Element {
  ...
  return (
    ...
    >
      <Input autoComplete="off" value={state.value} onInput={_onInput} readOnly={isReadonly} />
    </Form.Item>
  );
}
